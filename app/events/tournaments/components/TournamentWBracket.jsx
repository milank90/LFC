          ...
          <div key={index} className='col-md-3 col-12 d-flex flex-wrap text-center round1-match'>
            <div className='col-5 fighter'>
              <Link href={`/fighters/${(getParticipantInfo(getFighterIdAtPosition(tournamentData.a_round1fighters, position)).name || '').replace(/\s/g, '.')}`}>
                ...
                <p>{getParticipantInfo(getFighterIdAtPosition(tournamentData.a_round1fighters, position)).name || `Undecided`}</p>
              </Link>
            </div>
            ...
            <div className='col-5 fighter'>
              <Link href={`/fighters/${(getParticipantInfo(getFighterIdAtPosition(tournamentData.a_round1fighters, position + 1)).name || '').replace(/\s/g, '.')}`}>
                ...
                <p>{getParticipantInfo(getFighterIdAtPosition(tournamentData.a_round1fighters, position + 1)).name || `Undecided`}</p>
              </Link>
            </div>
        ...
        {[0, 2].map((position, index) => (
          <div key={index} className='col-md-6 col-12 justify-content-center d-flex text-center flex-wrap round2-match'>
            <div className='col-md-3 col-5 fighter'>
              <Link href={`/fighters/${(getParticipantInfo(getFighterIdAtPosition(tournamentData.a_round2fighters, position)).name || '').replace(/\s/g, '.')}`}>
                <Image src={getParticipantInfo(getFighterIdAtPosition(tournamentData.a_round2fighters, position)).img1 || '/Img/Blank-Profile-image-1.jpg'} alt="Event Image" layout="responsive" width={1000} height={2000} />
                <p>{getParticipantInfo(getFighterIdAtPosition(tournamentData.a_round2fighters, position)).name || `Undecided`}</p>
              </Link>
            </div>
            <p className='vs'>VS</p>
            <div className='col-md-3 col-5 fighter'>
              <Link href={`/fighters/${(getParticipantInfo(getFighterIdAtPosition(tournamentData.a_round2fighters, position + 1)).name || '').replace(/\s/g, '.')}`}>
                <Image src={getParticipantInfo(getFighterIdAtPosition(tournamentData.a_round2fighters, position + 1)).img1 || '/Img/Blank-Profile-image-1.jpg'} alt="Event Image" layout="responsive" width={1000} height={2000} />
                <p>{getParticipantInfo(getFighterIdAtPosition(tournamentData.a_round2fighters, position + 1)).name || `Undecided`}</p>
              </Link>
            </div>
            <div className='col-12 d-none d-md-block d-flex justify-content-center flex-wrap '>
              <div className='col-12 d-flex justify-content-center'>
        ...
        {[0].map((position, index) => (
          <div key={index} className='col-lg-12 col-md-10 col-12 d-flex justify-content-center text-center flex-wrap round3-match'>
            <div className='col-md-2 col-5 fighter'>
              <Link href={`/fighters/${(getParticipantInfo(getFighterIdAtPosition(tournamentData.a_round3fighters, position)).name || '').replace(/\s/g, '.')}`}>
                <Image src={getParticipantInfo(getFighterIdAtPosition(tournamentData.a_round3fighters, position)).img1 || '/Img/Blank-Profile-image-1.jpg'} alt="Event Image" layout="responsive" width={1000} height={2000} />
                <p>{getParticipantInfo(getFighterIdAtPosition(tournamentData.a_round3fighters, position)).name || `Undecided`}</p>
              </Link>
            </div>
            <p className='vs'>VS</p>
            <div className='col-md-2 col-5 fighter'>
              <Link href={`/fighters/${(getParticipantInfo(getFighterIdAtPosition(tournamentData.a_round3fighters, position + 1)).name || '').replace(/\s/g, '.')}`}>
                <Image src={getParticipantInfo(getFighterIdAtPosition(tournamentData.a_round3fighters, position + 1)).img1 || '/Img/Blank-Profile-image-1.jpg'} alt="Event Image" layout="responsive" width={1000} height={2000} />
                <p>{getParticipantInfo(getFighterIdAtPosition(tournamentData.a_round3fighters, position + 1)).name || `Undecided`}</p>
              </Link>
            </div>
            <div className='col-12 d-none d-md-block d-flex justify-content-center flex-wrap '>
              <div className='col-12 d-flex justify-content-center'>
