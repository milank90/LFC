...
const AddTournamentFightForm = () => {
  ...
  const deleteAllDocuments = async (TournamentFights) => {
    try {
      const collectionRef = collection(db, TournamentFights);
      ...
      console.log(`All documents in the '${TournamentFights}' collection deleted successfully.`);
    } catch (error) {
  ...
  return (
    <div style={{ marginTop: '300px' }}>
      ...
      <label htmlFor="eventID">Event ID:</label>
        <input type="text" name="eventID" value={formData.rel_eventID} onChange={handleInputChange} required />
...
export default AddTournamentFightForm;
